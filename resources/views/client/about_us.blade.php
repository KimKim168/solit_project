...
@section('content')
        ...
        <div class="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between  p-8 ">
            ...
            <div class="lg:w-1/2 mb-10 lg:mb-0">
                <button class="bg-gray-100  text-blue-600 px-5 py-2 rounded-full uppercase text-xs font-semibold mb-4"
                    ...
                    Know
                    Us</button>
                <h2 class="text-5xl md:text-6xl font-costum4 leading-normal font-bold bg-gradient-to-r font-bold from-[#e921f3] to-[#1900ff] text-transparent bg-clip-text mb-4"
    ...
    <section class="mt-20 p-5">
        <div class="max-w-screen-xl mx-auto ">
            <div class="">
                <h1
                    class="font-costum5 text-5xl md:text-5xl leading-normal  bg-gradient-to-r font-bold from-[#e921f3] to-[#1900ff] text-transparent bg-clip-text">
    ...
    <section class="mb-10 mt-5   lg:mt-20  px-4">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="sm:mb-8 md:col-span-4">
                ...
                <h2
                    class="text-4xl  leading-normal font-costum5 bg-gradient-to-r font-bold from-[#e921f3] to-[#1900ff] text-transparent bg-clip-text mb-4">
                    Why Choose Us?</h2>
