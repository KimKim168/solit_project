                    ...
                    <div>
                        ...
                        <ol class="list-decimal text-xl p-4 space-y-4">
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]"> We specialize in building bespoke mobile applications
                                ...
                                {{-- Item1 --}}
                                <ul class="list-disc px-4 space-y-2 text-sm md:text-[16px]">
                                    <li>
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]"> Our team of expert iOS developers is proficient in
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    App Development</strong>
                                <p class="text-sm md:text-[16px]">Our Android app development team creates apps that are
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    App Development</strong>
                                <p class="text-sm md:text-[16px]">To help you reach the widest possible audience, we offer
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    Design</strong>
                                <p class="text-sm md:text-[16px]">A great mobile app isn’t just about functionality; it’s
                                    also about delivering an
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">Our services don’t stop after launch. We offer ongoing
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">We build enterprise-level mobile applications that
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">For businesses looking to sell products or services
                                    online, we offer eCommerce and mobile
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">Our mobile app testing services ensure that your app is
                                    free of bugs and performs well
                    ...
                    <div class="border-t">
                        ...
                        <ol class="list-decimal text-xl p-4 space-y-4">
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">We begin by understanding your business goals and mobile
                                    app requirements. This phase
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    & Prototyping:</strong>
                                <p class="text-sm md:text-[16px]">Our design team creates wireframes and interactive
                                    prototypes to give you a clear vision
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    & Testing:</strong>
                                <p class="text-sm md:text-[16px]">Once the design is approved, our developers begin coding
                                    your app. We follow Agile
                            ...
                            <li class="space-y-2">
                                <strong
                                    ...
                                    & Deployment:</strong>
                                <p class="text-sm md:text-[16px]">After thorough testing, we prepare your app for launch. We
                            ...
                            <li class="space-y-2">
                                ...
                                <p class="text-sm md:text-[16px]">Post-launch, we continue to monitor the app’s performance,
